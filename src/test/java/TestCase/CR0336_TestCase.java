...
public class CR0336_TestCase extends BaseClass {
	...
	ExtentReports Report = new ExtentReports(
			"C:\\Users\\abhishekyt\\git\\repository\\Automation\\Reports\\CR0336_TestCase_"
	...
	// @Test
		void Pledge_Creation() throws IOException {
			try {
				...
				//Login.PortalLogin("RP-KUNVARJI", "PreProd_Abhi", "121@test");  //------PreProd Login------
		...
		void Pledge_Creation_Request_Authorized() throws IOException {
			try {
				...
				//Login.PortalLogin("RP-KUNVARJI", "PRAKASH", "121@test");  //------PreProd Login------
				test.log(LogStatus.PASS, test.addScreenCapture(TestPages.ScreenShort.CaptureScreen(driver)));
	...
	//	@Test
		void pledgee_Creation_Authorized() throws IOException {
			try {
				...
				LoginPages Login = new LoginPages(driver, Wait);
				Login.PortalLogin("rp-UCOBANK", "panvel2", "121@test01");
